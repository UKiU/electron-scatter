...
QT_MOC_LITERAL(1, 5, 6), // "onclxh"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 6), // "oncllx"
QT_MOC_LITERAL(4, 20, 6), // "onclkd"
QT_MOC_LITERAL(5, 27, 6), // "onclhd"
QT_MOC_LITERAL(6, 34, 7), // "ongkjmd"
QT_MOC_LITERAL(7, 42, 7), // "oncyzgs"
QT_MOC_LITERAL(8, 50, 7), // "onhyzgs"
QT_MOC_LITERAL(9, 58, 7) // "onoyzgs"

    },
    "Data\0onclxh\0\0oncllx\0onclkd\0onclhd\0"
    "ongkjmd\0oncyzgs\0onhyzgs\0onoyzgs"
};
...
void Data::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->onclxh();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: { int _r = _t->oncllx();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: { double _r = _t->onclkd();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 3: { double _r = _t->onclhd();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 4: { double _r = _t->ongkjmd();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 5: { int _r = _t->oncyzgs();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 6: { int _r = _t->onhyzgs();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 7: { int _r = _t->onoyzgs();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
